...
function scene:create(event)
    ...
    P.text(sg, "SCORE", W/2, 160, 10, native.systemFont, P.bark)
    local scoreNum = P.text(sg, "0", W/2, 196, 36, native.systemFontBold, cat.accentColor)
    ...
    for i, s in ipairs(statItems) do
        ...
        P.text(sg, s.label, sx, statsY-13, 9, native.systemFont, P.bark)
        P.text(sg, s.value, sx, statsY+8,  20, native.systemFontBold, cat.accentColor)
    end
    ...
    -- Main menu
    local menuT = P.text(sg, "← Main Menu", W/2, H-48, 13,
