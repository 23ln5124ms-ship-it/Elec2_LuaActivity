...
function scene:create(event)
    ...
    local backT = P.text(sg, "← back", 44, 38, 13,
                          native.systemFont, cat.accentColor)
    ...
    P.text(sg, cat.name, W/2, 130, 22, native.systemFontBold, cat.accentColor)
    P.text(sg, "choose difficulty", W/2, 155, 11,
    ...
    for i, diff in ipairs(DIFFICULTIES) do
        ...
        -- Description
        P.text(sg, diff.desc, W/2 + 14, cy + 8, 10,
